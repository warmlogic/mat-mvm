function soco2_prepData_summary(rejectArt,saveFiles,dataroot)
% function soco2_prepData_summary(rejectArt,saveFiles,averageSes,dataroot)
%
...
if nargin < 3
  ...
  elseif exist(serverLocalDir,'dir')
    ...
    uroot = getenv('HOME');
    dataroot = fullfile(uroot,'data',expName,'behavioral');
  end
  if nargin < 2
    saveFiles = true;
    if nargin < 1
