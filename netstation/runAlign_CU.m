function runAlign_CU(samplerate,beh_file,eeg_file,chan_files,log_files,ms_field,isfrei,isegi,moreAccurateAlign)
...
for f = 1:length(eeg_file)
  ...
  if ~moreAccurateAlign
      ...
      [a,err1]=logalign_CU(beh_in,eeg_in,chan_files,log_files,ms_field);
  else
      ...
      [a,err2]=logalign_CU(beh_in2,eeg_in2,chan_files,log_files,ms_field);
  end
