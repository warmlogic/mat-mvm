function [meddev,rawDevs]=logalign_CU(beh_ms,eeg_offset,eeg_files,log_files,ms_field)
...
%        events(l);
    ...
    if dostruct
      ...
      % This is the whole point of running through the eeg_toolbox functions
