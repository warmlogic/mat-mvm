...
fprintf('%.1f--%.1f s, %.1f--%.1f Hz: IV1: %s (%d;%s), IV2: %s (%d;%s), collapsing over %s (%d;%s)\n',...
  ...
  cfg_ana.IV_names{2},length(cfg_ana.types),sprintf(repmat(' %s',1,length(cfg_ana.types)),cfg_ana.types{:}),...
  cfg_ana.IV_names{3},length(cfg_ana.condCommon),sprintf(repmat(' %s',1,length(cfg_ana.condCommon)),cfg_ana.condCommon{:}));
[cfg_ana.p] = RMAOV2_mod(cfg_ana.anovamat_roi_type,cfg_ana.alpha,cfg_ana.showtable,cfg_ana.calcGGHF,0,1);
...
fprintf('%.1f--%.1f s, %.1f--%.1f Hz: IV1: %s (%d;%s), IV2: %s (%d;%s), collapsing over %s (%d;%s)\n',...
  ...
  cfg_ana.IV_names{3},length(cfg_ana.condCommon),sprintf(repmat(' %s',1,length(cfg_ana.condCommon)),cfg_ana.condCommon{:}),...
  cfg_ana.IV_names{2},length(cfg_ana.types),sprintf(repmat(' %s',1,length(cfg_ana.types)),cfg_ana.types{:}));
[cfg_ana.p] = RMAOV2_mod(cfg_ana.anovamat_roi_cond,cfg_ana.alpha,cfg_ana.showtable,cfg_ana.calcGGHF,0,1);
...
fprintf('%.1f--%.1f s, %.1f--%.1f Hz: IV1: %s (%d;%s), IV2: %s (%d;%s), collapsing over %s (%d;%s)\n',...
  ...
  cfg_ana.IV_names{3},length(cfg_ana.condCommon),sprintf(repmat(' %s',1,length(cfg_ana.condCommon)),cfg_ana.condCommon{:}),...
  cfg_ana.IV_names{1},length(cfg_ana.roi),cfg_ana.chan_str);
[cfg_ana.p] = RMAOV2_mod(cfg_ana.anovamat_type_cond,cfg_ana.alpha,cfg_ana.showtable,cfg_ana.calcGGHF,0,1);
