...
% Default is {'none'}. ~~Added 'rawThresh'.
%
...
artifactOpts = {'none','nsAuto','zeroVar','badChanManual','badChanEP','rmBadChan','preRejManual','ftAuto','ftManual','ftICA','rawThresh'};
...
for ses = 1:length(session)
  ...
  if ~rejArt
    ...
    [data_seg,badChan,badEv,artftcdef] = nemo_mm_ft_artifact(dataroot,subject,sesName,eventValue_orig,ana,exper,elecfile,data_seg,dirs);
