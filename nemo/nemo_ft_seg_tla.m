...
% corrct events
exper.eventValues = {{'ao_standard_corr','ao_target_corr', 'study_prime_corr', 'study_targ_AA_rel_corr',...
    'study_targ_AA_unrel_corr','study_targ_CA_rel_corr','study_targ_CA_unrel_corr','test_targ_A_new_corr',...
...
if ana.useExpInfo
  ...
  % values listed in exper.eventValues
   ana.trl_order.ao_standard_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time'};
 
  ana.trl_order.ao_target_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time'}; 
  
  ana.trl_order.study_prime_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time',...
  ...
  ana.trl_order.study_targ_AA_rel_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.study_targ_AA_unrel_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.study_targ_CA_rel_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.study_targ_CA_unrel_corr = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
