...
% corrct events
exper.eventValues = {{'AO_Standard_COR','AO_Target_COR', 'study_prime', 'Target_AA_REL_COR',...
    'Target_AA_UNR_COR','Target_CA_REL_COR','Target_CA_UNR_COR','Test_A_NEW_COR',...
    'Test_AA_OLD_COR','Test_CA_OLD_COR'}};
...
if ana.useExpInfo
  ...
  % values listed in exper.eventValues
   ana.trl_order.AO_Standard_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number'};
 
  ana.trl_order.AO_Target_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number'}; 
  ...
  ana.trl_order.Target_AA_REL_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Target_AA_UNR_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Target_CA_REL_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Target_CA_UNR_COR = {'eventNumber', 'phaseType', 'trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Test_A_NEW_COR = {'eventNumber', 'phaseType','trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Test_AA_OLD_COR = {'eventNumber', 'phaseType','trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
  ...
  ana.trl_order.Test_CA_OLD_COR = {'eventNumber', 'phaseType','trial','cell_label',...
      'times_studied','resp_value','accuracy','reaction_time','random_number',...
      'FSG_target','BSG_target','CNC_target','KFFRQ_target','NLET_target','NPHON_target',...
      'NSYLL_target','orthoN_target','phonoN_target','AOA_target','BFRQ_target',...
      'FAM_target','IMG_target','CMEAN_target','PMEAN_target','TLFRQ_target',...
