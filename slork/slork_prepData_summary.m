function slork_prepData_summary(rejectArt,saveFiles,dataroot)
% function slork_prepData_summary(rejectArt,saveFiles,dataroot)
%
...
% 28 had problems
% 37 does not exist
% 41 was first run without recording eeg. ran a diff sub with same number.
...
if rejectArt == 0
  tableHeader = {'sub','ses',... % subject info
    ...
    'IRK Corr Fam','IRK Inc Fam',... % Independent Remember--Know Familiarity rates
  ...
  for sub = 1:length(subjects)
    ...
    for ses = 1:length(sessions)
      ...
      if rejectArt == 0
        ...
        % explained in slork_createEvents.m
      ...
      if rejectArt == 0
        tableData = [...
          ...
          irk_correct_Fam,irk_incorrect_Fam,... % Independent Remember--Know Familiarity rates
