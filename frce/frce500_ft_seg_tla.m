...
cfg_ft = [];
%cfg_ft.xlim = [-0.5 1.25];
cfg_ft.xlim = exper.prepost;
...
cfg_plot.rois = {{'LAS','RAS'},{'LPS','RPS'}};
cfg_plot.ylims = [-3 3; -1 3];
cfg_plot.x_bounds = [0.3 0.5; 0.5 0.8];
