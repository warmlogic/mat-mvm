      ...
      for f = 1:length(allFreqs)
        ...
        for s = 1:length(allSimMethod)
          ...
          for e = 1:length(allEigCrit)
            ...
            space_rsa_pca_tla_hilbert_classif_cluster(saveDirProc,replaceDataroot,replaceDatatype,allowRecallSynonyms,accurateClassifSelect,date_string,dataTypes,cfg_sel,subjects,sesNames,thisROI,latencies,freqs,sim_method,eig_criterion);
          end
        end
      end
    end
