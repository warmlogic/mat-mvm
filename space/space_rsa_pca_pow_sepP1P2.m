...
save(fullfile(dirs.saveDirProc,sprintf('RSA_PCA_pow_%dlat_%sAvgT_%sAvgF_sepP1P2_%s.mat',size(latencies,1),cfg_sel.avgovertime,cfg_sel.avgoverfreq,date)),'subjects_all','sesNames_all','dataTypes','thisROI','cfg_sel','eig_criterion','freqs','latencies','similarity_all','similarity_ntrials');
