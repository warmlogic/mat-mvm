function space_rsa_pca_tla_hilbert_classif_cluster(procDir,replaceDataroot,replaceDatatype,allowRecallSynonyms,accurateClassifSelect,date_string,dataTypes,cfg_sel,subjects,sesNames,thisROI,latencies,freqs,sim_method,eig_criterion)
...
%         end
    ...
    saveFile = fullfile(dirs.saveDirProc,exper.subjects{sub},exper.sesStr{ses},sprintf('RSA_PCA_hilbert_%s_%s_%s_%s_%s_%dlat_%s_%sAvgT_%s.mat',data_str,sim_method,classif_str,eig_criterion,roi_str,size(latencies,1),freq_str,cfg_sel.avgovertime,date_string));
    fprintf('Saving: %s\n',saveFile);
