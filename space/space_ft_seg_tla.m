...
ana.eventValuesSplit = {...
  {'img_rgr_rcr_s_p1','img_rgr_rcr_s_p2','img_rgr_rcr_m_p1','img_rgr_rcr_m_p2', ...
  'img_rgr_rcf_s_p1','img_rgr_rcf_s_p2','img_rgr_rcf_m_p1','img_rgr_rcf_m_p2', ...
  'img_rgf_s_p1','img_rgf_s_p2','img_rgf_m_p1','img_rgf_m_p2'}, ...
  {'word_rgr_rcr_s_p1','word_rgr_rcr_s_p2','word_rgr_rcr_m_p1','word_rgr_rcr_m_p2', ...
  'word_rgr_rcf_s_p1','word_rgr_rcf_s_p2','word_rgr_rcf_m_p1','word_rgr_rcf_m_p2', ...
  'word_rgf_s_p1','word_rgf_s_p2','word_rgf_m_p1','word_rgf_m_p2'}};
ana.trl_expr = {...
  {sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_image'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_image'))), ...
  ...
  {sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 1 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues,'multistudy_word'))), ...
  sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 1 & cr_recall_resp == 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues,'multistudy_word'))), ...
