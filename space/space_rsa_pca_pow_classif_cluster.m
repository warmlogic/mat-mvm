function space_rsa_pca_pow_classif_cluster(procDir,replaceDataroot,replaceDatatype,allowRecallSynonyms,accurateClassifSelect,date_string,dataTypes,cfg_sel,subjects_all,sesNames_all,thisROI,latencies,freqs,sim_method,eig_criterion)
