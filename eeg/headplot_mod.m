...
function [HeadAxes, ColorbarHandle] = headplot_mod(values, arg1, varargin)
...
%
    ...
    if ~strcmpi(g.plotmeshonly, 'off')
        ...
        plotelec(newElect, ElectrodeNames, HeadCenter, plotelecopt,g); % PBS
        rotate3d;
        return;
    end;
...
% plot electrodes
% %%%%%%%%%%%%%%%
function plotelec(newElect, ElectrodeNames, HeadCenter, opt,g); % PBS
