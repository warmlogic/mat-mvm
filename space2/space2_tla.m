...
if allowRecallSynonyms
  ana.trl_expr = { ...
    ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr == 0) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
  ...
  ana.trl_expr = { ...
    ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & ((cr_recog_acc == 1 & cr_recall_spellCorr < 1) | cr_recog_acc == 0) & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 1 & lag > 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 1 & lag > 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    %sprintf('eventNumber == %d & targ == 1 & cr_recog_acc == 0  & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
