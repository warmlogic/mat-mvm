...
if allowRecallSynonyms
  ana.trl_expr = { ...
    ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 2 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 2 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 2 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 2 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 12 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 12 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 12 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 12 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 32 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 32 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 32 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 32 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_image'))) ...
    } ...
    { ...
    sprintf('eventNumber == %d & targ == 1 & spaced == 0 & lag == -1 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 0 & lag == 0 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 0 & lag == 0 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 2 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 2 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 2 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 2 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 12 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 12 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 12 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 12 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 32 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr > 0 & spaced == 1 & lag == 32 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 32 & presNum == 1',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    sprintf('eventNumber == %d & targ == 1 & cr_recall_spellCorr == 0 & spaced == 1 & lag == 32 & presNum == 2',find(ismember(exper.eventValues{sesNum},'multistudy_word'))) ...
    } ...
    } ...
...
cfg_plot.condByROI = repmat({{ ...
  'word_rc_spac2_p1', 'word_fo_spac2_p1', ...
  'word_rc_spac12_p1', 'word_fo_spac12_p1', ...
  'word_rc_spac32_p1', 'word_fo_spac32_p1', ...
  'word_rc_mass_p1', 'word_fo_mass_p1', ...
  %'word_rc_spac2_p2', 'word_fo_spac2_p2', ...
  %'word_rc_spac12_p2', 'word_fo_spac12_p2', ...
  %'word_rc_spac32_p2', 'word_fo_spac32_p2', ...
  %'word_rc_mass_p2', 'word_fo_mass_p2' , ...
  %'word_onePres' ...
  }},size(cfg_plot.rois));
...
% % words, all together
cfg.conditions = {'word_onePres','word_rc_spac_p1','word_fo_spac_p1','word_rc_spac_p2','word_fo_spac_p2','word_rc_mass_p1','word_fo_mass_p1','word_rc_mass_p2','word_fo_mass_p2'};
...
cfg_plot.condByROI = repmat({{{'word_rc_spac_p1','word_fo_spac_p1','word_rc_spac_p2','word_fo_spac_p2'}}},size(cfg_plot.rois));
