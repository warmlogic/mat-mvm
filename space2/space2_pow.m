...
save(fullfile(saveDir,'space2_word_img_data_pow_noSyn_wordBL.mat'),'data_pow','exper','ana','dirs','files','-v7.3');
% clear data_pow
...
load(fullfile(loadDir,'space2_word_img_data_pow_noSyn_wordBL.mat'));
...
% cfg_plot.condByROI = repmat({{{{'word_rc_spac2_p2','word_rc_spac12_p2','word_rc_spac32_p2','word_rc_mass_p2'}}}},size(cfg_plot.rois));
% cfg_plot.condByROI = repmat({{{{'word_fo_spac2_p2'}}}},size(cfg_plot.rois));
cfg_plot.condByROI = repmat({{{{'img_rc_spac2_p2'}}}},size(cfg_plot.rois));
...
% cfg.conditions = {{'word_rc_mass_p2','word_fo_mass_p2','word_rc_spac_p2','word_fo_spac_p2'}};
% cfg.conditions = {{'img_onePres','img_rc_mass_p2','img_fo_mass_p2','img_rc_spac_p2','img_fo_spac_p2'}};
...
cfg.rename_conditions = {{'Mass P2 Recall','Mass P2 Forgot','Space2 P2 Recalled','Space2 P2 Forgot','Space12 P2 Recalled','Space12 P2 Forgot','Space32 P2 Recalled','Space32 P2 Forgot'}};
cfg.graphcolor = 'bcrm';
cfg.linestyle = {'-','--','-','--'};
...
cfg_plot.rename_conditions = {'Mass P2 Recall','Mass P2 Forgot','Space2 P2 Recalled','Space2 P2 Forgot','Space12 P2 Recalled','Space12 P2 Forgot','Space32 P2 Recalled','Space32 P2 Forgot'};
...
% TODO fix condition pairs

% Actual analysis: only P2
...
% cfg_ana.conditions = {{'word_spac_p1', 'word_mass_p1'}, {'word_spac_p2', 'word_mass_p2'}, ...
%   {'img_spac_p1', 'img_mass_p1'}, {'img_spac_p2', 'img_mass_p2'}};
...
cfg_ana.conditions = {...
  ...
  {'img_rc_mass_p2', 'img_fo_spac2_p2'} ... % P2 Spac2 x mem
  {'img_rc_mass_p2', 'img_fo_spac12_p2'} ... % P2 Spac12 x mem
  {'img_rc_mass_p2', 'img_fo_spac32_p2'} ... % P2 Spac32 x mem
  ...
  {'img_rc_onePres', 'img_rc_mass_p2'} ...
  {'img_rc_onePres', 'img_fo_mass_p2'} ...
  {'img_rc_onePres', 'img_rc_spac2_p2'} ...
  {'img_rc_onePres', 'img_fo_spac2_p2'} ...
  {'img_rc_onePres', 'img_rc_spac12_p2'} ...
  {'img_rc_onePres', 'img_fo_spac12_p2'} ...
  {'img_rc_onePres', 'img_rc_spac32_p2'} ...
  {'img_rc_onePres', 'img_fo_spac32_p2'} ...
  {'img_fo_onePres', 'img_rc_mass_p2'} ...
  {'img_fo_onePres', 'img_fo_mass_p2'} ...
  {'img_fo_onePres', 'img_rc_spac2_p2'} ...
  {'img_fo_onePres', 'img_fo_spac2_p2'} ...
  {'img_fo_onePres', 'img_rc_spac12_p2'} ...
  {'img_fo_onePres', 'img_fo_spac12_p2'} ...
  ...
  {'word_rc_mass_p2', 'word_fo_spac2_p2'} ... % P2 Spac2 x mem
  {'word_rc_mass_p2', 'word_fo_spac12_p2'} ... % P2 Spac12 x mem
  {'word_rc_mass_p2', 'word_fo_spac32_p2'} ... % P2 Spac32 x mem
  ...
  {'word_rc_onePres', 'word_rc_mass_p2'} ...
  {'word_rc_onePres', 'word_fo_mass_p2'} ...
  {'word_rc_onePres', 'word_rc_spac2_p2'} ...
  {'word_rc_onePres', 'word_fo_spac2_p2'} ...
  {'word_rc_onePres', 'word_rc_spac12_p2'} ...
  {'word_rc_onePres', 'word_fo_spac12_p2'} ...
  {'word_rc_onePres', 'word_rc_spac32_p2'} ...
  {'word_rc_onePres', 'word_fo_spac32_p2'} ...
  {'word_fo_onePres', 'word_rc_mass_p2'} ...
  {'word_fo_onePres', 'word_fo_mass_p2'} ...
  {'word_fo_onePres', 'word_rc_spac2_p2'} ...
  {'word_fo_onePres', 'word_fo_spac2_p2'} ...
  {'word_fo_onePres', 'word_rc_spac12_p2'} ...
  {'word_fo_onePres', 'word_fo_spac12_p2'} ...
  {'word_fo_onePres', 'word_rc_spac32_p2'} ...
  {'word_fo_onePres', 'word_fo_spac32_p2'} ...
};
...
%   {'img_rc_spac2_p1', 'img_rc_spac2_p2'} ... % Spac2 Rc Repetition
%   {'img_fo_spac2_p1', 'img_fo_spac2_p2'} ... % Spac2 Fo Repetition
%   {'img_rc_spac2_p1', 'img_rc_mass_p1'} ... % P1 Rc Spac2
%   {'img_fo_spac2_p1', 'img_fo_mass_p1'} ... % P1 Fo Spac2
%   {'img_rc_spac12_p1', 'img_rc_spac12_p2'} ... % Spac12 Rc Repetition
%   {'img_fo_spac12_p1', 'img_fo_spac12_p2'} ... % Spac12 Fo Repetition
%   {'img_rc_spac12_p1', 'img_rc_mass_p1'} ... % P1 Rc Spac12
%   {'img_fo_spac12_p1', 'img_fo_mass_p1'} ... % P1 Fo Spac12
%   {'img_rc_spac32_p1', 'img_rc_spac32_p2'} ... % Spac32 Rc Repetition
%   {'img_fo_spac32_p1', 'img_fo_spac32_p2'} ... % Spac32 Fo Repetition
%   {'img_rc_spac32_p1', 'img_rc_mass_p1'} ... % P1 Rc Spac32
%   {'img_fo_spac32_p1', 'img_fo_mass_p1'} ... % P1 Fo Spac32

%   {'img_rc_spac2_p1', 'img_fo_mass_p1'} ... % P1 Spac2 x mem
%   {'img_rc_mass_p1', 'img_fo_spac2_p1'} ... % P1 Spac2 x mem

%   {'img_rc_onePres', 'img_rc_mass_p1'} ...
%   {'img_rc_onePres', 'img_fo_mass_p1'} ...
%   {'img_rc_onePres', 'img_rc_spac2_p1'} ...
%   {'img_rc_onePres', 'img_fo_spac2_p1'} ...
%   {'img_rc_onePres', 'img_rc_spac12_p1'} ...
%   {'img_rc_onePres', 'img_fo_spac12_p1'} ...
%   {'img_rc_onePres', 'img_rc_spac32_p1'} ...
%   {'img_rc_onePres', 'img_fo_spac32_p1'} ...

%   {'img_fo_onePres', 'img_rc_mass_p1'} ...
%   {'img_fo_onePres', 'img_fo_mass_p1'} ...
%   {'img_fo_onePres', 'img_rc_spac2_p1'} ...
%   {'img_fo_onePres', 'img_fo_spac2_p1'} ...
%   {'img_fo_onePres', 'img_rc_spac12_p1'} ...
%   {'img_fo_onePres', 'img_fo_spac12_p1'} ...
%   {'img_fo_onePres', 'img_rc_spac32_p1'} ...
...
%   {'word_rc_spac2_p1', 'word_rc_spac2_p2'} ... % Spac2 Rc Repetition
%   {'word_fo_spac2_p1', 'word_fo_spac2_p2'} ... % Spac2 Fo Repetition
%   {'word_rc_spac2_p1', 'word_rc_mass_p1'} ... % P1 Rc Spac2
%   {'word_fo_spac2_p1', 'word_fo_mass_p1'} ... % P1 Fo Spac2
%   {'word_rc_spac12_p1', 'word_rc_spac12_p2'} ... % Spac12 Rc Repetition
%   {'word_fo_spac12_p1', 'word_fo_spac12_p2'} ... % Spac12 Fo Repetition
%   {'word_rc_spac12_p1', 'word_rc_mass_p1'} ... % P1 Rc Spac12
%   {'word_fo_spac12_p1', 'word_fo_mass_p1'} ... % P1 Fo Spac12
%   {'word_rc_spac32_p1', 'word_rc_spac32_p2'} ... % Spac32 Rc Repetition
%   {'word_fo_spac32_p1', 'word_fo_spac32_p2'} ... % Spac32 Fo Repetition
%   {'word_rc_spac32_p1', 'word_rc_mass_p1'} ... % P1 Rc Spac32
%   {'word_fo_spac32_p1', 'word_fo_mass_p1'} ... % P1 Fo Spac32

%   {'word_rc_spac2_p1', 'word_fo_mass_p1'} ... % P1 Spac2 x mem
%   {'word_rc_mass_p1', 'word_fo_spac2_p1'} ... % P1 Spac2 x mem

%   {'word_rc_onePres', 'word_rc_mass_p1'} ...
%   {'word_rc_onePres', 'word_fo_mass_p1'} ...
%   {'word_rc_onePres', 'word_rc_spac2_p1'} ...
%   {'word_rc_onePres', 'word_fo_spac2_p1'} ...
%   {'word_rc_onePres', 'word_rc_spac12_p1'} ...
%   {'word_rc_onePres', 'word_fo_spac12_p1'} ...
%   {'word_rc_onePres', 'word_rc_spac32_p1'} ...
%   {'word_rc_onePres', 'word_fo_spac32_p1'} ...

%   {'word_fo_onePres', 'word_rc_mass_p1'} ...
%   {'word_fo_onePres', 'word_fo_mass_p1'} ...
%   {'word_fo_onePres', 'word_rc_spac2_p1'} ...
%   {'word_fo_onePres', 'word_fo_spac2_p1'} ...
%   {'word_fo_onePres', 'word_rc_spac12_p1'} ...
%   {'word_fo_onePres', 'word_fo_spac12_p1'} ...
%   {'word_fo_onePres', 'word_rc_spac32_p1'} ...
%   {'word_fo_onePres', 'word_fo_spac32_p1'} ...
...
% cfg.conditions = {...
%   {'word_onePres', 'word_rc_spac_p1', 'word_rc_mass_p1'} ...
%   {'word_onePres', 'word_fo_spac_p1', 'word_fo_mass_p1'} ...
%   {'word_onePres', 'word_rc_spac_p1', 'word_fo_spac_p1'} ...
%   {'word_onePres', 'word_rc_mass_p1', 'word_fo_mass_p1'} ...
%   {'word_onePres', 'word_rc_spac_p2', 'word_rc_mass_p2'} ...
%   {'word_onePres', 'word_fo_spac_p2', 'word_fo_mass_p2'} ...
%   {'word_onePres', 'word_rc_spac_p2', 'word_fo_spac_p2'} ...
%   {'word_onePres', 'word_rc_mass_p2', 'word_fo_mass_p2'} ...
%   };

cfg.conditions = {...
  {'img_onePres', 'img_rc_spac_p1', 'img_rc_mass_p1'} ...
  {'img_onePres', 'img_fo_spac_p1', 'img_fo_mass_p1'} ...
  {'img_onePres', 'img_rc_spac_p1', 'img_fo_spac_p1'} ...
  {'img_onePres', 'img_rc_mass_p1', 'img_fo_mass_p1'} ...
  {'img_onePres', 'img_rc_spac_p2', 'img_rc_mass_p2'} ...
  {'img_onePres', 'img_fo_spac_p2', 'img_fo_mass_p2'} ...
  {'img_onePres', 'img_rc_spac_p2', 'img_fo_spac_p2'} ...
  {'img_onePres', 'img_rc_mass_p2', 'img_fo_mass_p2'} ...
  {'word_onePres', 'word_rc_spac_p1', 'word_rc_mass_p1'} ...
  {'word_onePres', 'word_fo_spac_p1', 'word_fo_mass_p1'} ...
  {'word_onePres', 'word_rc_spac_p1', 'word_fo_spac_p1'} ...
  {'word_onePres', 'word_rc_mass_p1', 'word_fo_mass_p1'} ...
...
% cfg.conditions = {{'img_onePres','img_rc_spac_p2','img_fo_spac_p2','img_rc_mass_p2','img_fo_mass_p2'}};

%   {'img_onePres', 'img_rc_spac_p2'} ...
%   {'img_onePres', 'img_rc_mass_p2'} ...
%   {'img_onePres', 'img_fo_spac_p2'} ...
%   {'img_onePres', 'img_fo_mass_p2'} ...
%   {'word_rc_spac_p1', 'word_rc_mass_p1'} ...
%   {'word_fo_spac_p1', 'word_fo_mass_p1'} ...
%   {'img_fo_spac_p1', 'img_fo_mass_p1'} ...
%   {'img_rc_spac_p1', 'img_rc_mass_p1'} ...
%   {'img_rc_spac_p2', 'img_rc_mass_p2'} ...
%   {'img_fo_spac_p2', 'img_fo_mass_p2'} ...
%   {'img_rc_spac_p2', 'img_fo_spac_p2'} ...
%   {'img_rc_mass_p2', 'img_fo_mass_p2'} ...
...
% cfg.conditions = {{'img_rc_spac_p2','img_fo_spac_p2','img_rc_mass_p2','img_fo_mass_p2'}};
...
% cfg_plot.conditions = {...
%   {'img_rc_spac_p1', 'img_fo_spac_p1'} ... % Spac P1 SME
%   {'img_rc_spac_p2', 'img_fo_spac_p2'} ... % Spac P2 SME
%   {'img_rc_mass_p1', 'img_fo_mass_p1'} ... % Mass P1 SME
%   {'img_rc_mass_p2', 'img_fo_mass_p2'} ... % Mass P2 SME
%   {'img_rc_spac_p1', 'img_rc_spac_p2'} ... % Spac Rc Repetition
%   {'img_fo_spac_p1', 'img_fo_spac_p2'} ... % Spac Fo Repetition
%   {'img_rc_mass_p1', 'img_rc_mass_p2'} ... % Mass Rc Repetition
%   {'img_fo_mass_p1', 'img_fo_mass_p2'} ... % Mass Fo Repetition
%   {'img_rc_spac_p1', 'img_rc_mass_p1'} ... % P1 Rc Spacing
%   {'img_rc_spac_p2', 'img_rc_mass_p2'} ... % P2 Rc Spacing
%   {'img_fo_spac_p1', 'img_fo_mass_p1'} ... % P1 Fo Spacing
%   {'img_fo_spac_p2', 'img_fo_mass_p2'} ... % P2 Fo Spacing
%   {'img_rc_spac_p1', 'img_fo_mass_p1'} ... % P1 spac x mem
%   {'img_rc_mass_p1', 'img_fo_spac_p1'} ... % P1 spac x mem
%   {'img_rc_spac_p2', 'img_fo_mass_p2'} ... % P2 spac x mem
%   {'img_rc_mass_p2', 'img_fo_spac_p2'} ... % P2 spac x mem
%   {'img_onePres', 'img_rc_spac_p1'} ...
%   {'img_onePres', 'img_rc_mass_p1'} ...
%   {'img_onePres', 'img_fo_spac_p1'} ...
%   {'img_onePres', 'img_fo_mass_p1'} ...
%   {'img_onePres', 'img_rc_spac_p2'} ...
%   {'img_onePres', 'img_rc_mass_p2'} ...
%   {'img_onePres', 'img_fo_spac_p2'} ...
%   {'img_onePres', 'img_fo_mass_p2'} ...
%   {'word_rc_spac_p1', 'word_fo_spac_p1'} ... % Spac P1 SME
%   {'word_rc_spac_p2', 'word_fo_spac_p2'} ... % Spac P2 SME
%   {'word_rc_mass_p1', 'word_fo_mass_p1'} ... % Mass P1 SME
%   {'word_rc_mass_p2', 'word_fo_mass_p2'} ... % Mass P2 SME
%   {'word_rc_spac_p1', 'word_rc_spac_p2'} ... % Spac Rc Repetition
%   {'word_fo_spac_p1', 'word_fo_spac_p2'} ... % Spac Fo Repetition
%   {'word_rc_mass_p1', 'word_rc_mass_p2'} ... % Mass Rc Repetition
%   {'word_fo_mass_p1', 'word_fo_mass_p2'} ... % Mass Fo Repetition
%   {'word_rc_spac_p1', 'word_rc_mass_p1'} ... % P1 Rc Spacing
%   {'word_rc_spac_p2', 'word_rc_mass_p2'} ... % P2 Rc Spacing
%   {'word_fo_spac_p1', 'word_fo_mass_p1'} ... % P1 Fo Spacing
%   {'word_fo_spac_p2', 'word_fo_mass_p2'} ... % P2 Fo Spacing
%   {'word_rc_spac_p1', 'word_fo_mass_p1'} ... % P1 spac x mem
%   {'word_rc_mass_p1', 'word_fo_spac_p1'} ... % P1 spac x mem
%   {'word_rc_spac_p2', 'word_fo_mass_p2'} ... % P2 spac x mem
%   {'word_rc_mass_p2', 'word_fo_spac_p2'} ... % P2 spac x mem
%   {'word_onePres', 'word_rc_spac_p1'} ...
%   {'word_onePres', 'word_rc_mass_p1'} ...
%   {'word_onePres', 'word_fo_spac_p1'} ...
%   {'word_onePres', 'word_fo_mass_p1'} ...
%   {'word_onePres', 'word_rc_spac_p2'} ...
%   {'word_onePres', 'word_rc_mass_p2'} ...
%   {'word_onePres', 'word_fo_spac_p2'} ...
%   {'word_onePres', 'word_fo_mass_p2'} ...
% };
...
RgH_rc_spac = squeeze(mean_similarity.(sprintf('%s_rc_spac',data_str))(theseSub,ses,latInd));
RgH_fo_spac = squeeze(mean_similarity.(sprintf('%s_fo_spac',data_str))(theseSub,ses,latInd));
RgH_rc_mass = squeeze(mean_similarity.(sprintf('%s_rc_mass',data_str))(theseSub,ses,latInd));
RgH_fo_mass = squeeze(mean_similarity.(sprintf('%s_fo_mass',data_str))(theseSub,ses,latInd));
