...
cfg.conditions = {{'word_rc_mass_p2', 'word_fo_mass_p2', 'word_rc_spac2_p2', 'word_fo_spac2_p2'}};
% cfg.conditions = {{'img_rc_mass_p2', 'img_fo_mass_p2', 'img_rc_spac2_p2', 'img_fo_spac2_p2'}};
