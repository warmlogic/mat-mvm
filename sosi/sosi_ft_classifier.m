...
eunho73 = [3 4 5 6 7 9 10 11 12 13 15 16 18 19 20 22 23 24 27 28 29 30 31 34 35 36 37 40 41 42 46 47 51 52 53 54 55 59 60 61 62 66 67 71 72 76 77 78 79 80 84 85 86 87 91 92 93 97 98 102 103 104 105 106 109 110 111 112 116 117 118 123 124];
...
cfg.channel = eval(sprintf('{%s}',sprintf(repmat('''E%d'' ',size(eunho73)),(eunho73))));
...
for sub = 1:length(cfg_prep.subjs)
  ...
  for frq = 1:size(cfg_prep.freqs,1)
    ...
    %cfg.channels = eval(sprintf('{%s}',sprintf(repmat('''E%d'' ',size(eunho73)),(eunho73))));
